...
>
> 参考链接： [SpringBoot 之全局异常处理](https://juejin.im/post/5cbc744a6fb9a0685a3f01a7)_
>
> 推荐博客：[glmapper 的 logback 博客](https://juejin.im/post/5b51f85c5188251af91a7525)，[logback-spring.xml 配置文件](https://blog.csdn.net/xu_san_duo/article/details/80364600)
>
> 代码地址：[github](https://github.com/adolphmaster/javatools/tree/master/src/main/java/com/adolph/javatools/common)
...
4.  响应数据由于为 json 格式，可定义为 JsonObject 或 Map 形式；
...
public class TeacherAdminController {
    ...
    public ResultResponse list() {
        ...
        return ResultResponse.ok().data("itms", list).message("用户列表");
    }
}  
```
...
_统一结果类的使用参考了 mybatis-plus 中 R 对象的设计_
...
```java
import com._4paradigm.data.analysis.common.response.ResultCodeEnum;
...
```java
import com._4paradigm.data.analysis.common.response.ResultCodeEnum;
import com._4paradigm.data.analysis.common.response.ResultResponse;
...
_本节介绍统一异常较为简略，推荐博客 [SpringBoot 之全局异常处理](https://juejin.im/post/5cbc744a6fb9a0685a3f01a7)_
...
关于 logback 的配置和介绍，可以参考[官网](http://logback.qos.ch/documentation.html)或推荐博客 [glmapper 的 logback 博客](https://juejin.im/post/5b51f85c5188251af91a7525)，[logback-spring.xml 配置文件](https://blog.csdn.net/xu_san_duo/article/details/80364600)
...
3.  本地 idea 调试时，推荐 Grep Console 插件可实现控制台的自定义颜色输出

详细过程，可参考源代码：[github.com/chetwhy/clo…](https://github.com/chetwhy/cloud-flow)